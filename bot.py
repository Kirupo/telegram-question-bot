...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Done
        ...
        start_button = [[InlineKeyboardButton("/start", callback_data="restart")]]
        await query.edit_message_text(thank_you_text, reply_markup=InlineKeyboardMarkup(start_button))
    ...
    # Restart from /start inline button
    elif data == "restart":
